...
_RESULT_TO_SEND_STATUS: dict[str, SendStatus] = {
    ...
    # روبیکا v2 — user_account (rubpy)
    "rubika_user_session_missing": SendStatus.FAILED_PERMANENT,
    "rubika_user_session_invalid": SendStatus.FAILED_PERMANENT,
    "rubika_user_account_disabled": SendStatus.FAILED_PERMANENT,
    "rubika_user_contact_missing": SendStatus.FAILED_PERMANENT,
    "rubika_user_phone_not_resolved": SendStatus.FAILED_PERMANENT,
    "rubika_user_no_account_available": SendStatus.FAILED_RETRYABLE,
    "rubika_user_outside_send_window": SendStatus.FAILED_RETRYABLE,
    "rubika_user_rate_limited": SendStatus.FAILED_RETRYABLE,
    "rubika_user_api_error": SendStatus.FAILED_RETRYABLE,
    "rubika_user_unexpected_error": SendStatus.FAILED_RETRYABLE,
    "rubika_account_missing": SendStatus.FAILED_PERMANENT,
    "rubika_wrong_platform": SendStatus.FAILED_PERMANENT,
    "rubika_account_disabled": SendStatus.FAILED_PERMANENT,
    "rubika_account_banned": SendStatus.FAILED_PERMANENT,
    "rubika_account_requires_login": SendStatus.FAILED_PERMANENT,
    "rubika_account_identifier_missing": SendStatus.FAILED_PERMANENT,
    "rubika_session_invalid": SendStatus.FAILED_PERMANENT,
    "rubika_session_decrypt_failed": SendStatus.FAILED_PERMANENT,
    "rubika_config_invalid": SendStatus.FAILED_PERMANENT,
    "rubika_delivery_mode_disabled": SendStatus.FAILED_PERMANENT,
    "rubika_account_not_in_allowed_pool": SendStatus.FAILED_RETRYABLE,
    "rubika_campaign_account_not_allowed": SendStatus.FAILED_PERMANENT,
    "rubika_cooldown_active": SendStatus.FAILED_RETRYABLE,
    "rubika_hourly_cap_reached": SendStatus.FAILED_RETRYABLE,
    "rubika_daily_cap_reached": SendStatus.FAILED_RETRYABLE,
    "rubika_min_interval_active": SendStatus.FAILED_RETRYABLE,
    ...
    "skipped_duplicate": SendStatus.BLACKLISTED,
...
_RESULT_TO_ATTEMPT_STATUS: dict[str, MessageAttemptStatus] = {
    ...
    # روبیکا v2 — user_account (rubpy)
    "rubika_user_session_missing": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_user_session_invalid": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_user_account_disabled": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_user_contact_missing": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_user_phone_not_resolved": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_user_no_account_available": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_user_outside_send_window": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_user_rate_limited": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_user_api_error": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_user_unexpected_error": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_account_missing": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_wrong_platform": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_account_disabled": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_account_banned": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_account_requires_login": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_account_identifier_missing": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_session_invalid": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_session_decrypt_failed": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_config_invalid": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_delivery_mode_disabled": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_account_not_in_allowed_pool": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_campaign_account_not_allowed": MessageAttemptStatus.FAILED_PERMANENT,
    "rubika_cooldown_active": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_hourly_cap_reached": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_daily_cap_reached": MessageAttemptStatus.FAILED_RETRYABLE,
    "rubika_min_interval_active": MessageAttemptStatus.FAILED_RETRYABLE,
